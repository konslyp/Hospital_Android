package com.songu.pom.listener;
...
public class SimpleGestureFilter extends GestureDetector.SimpleOnGestureListener {
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
        ...
        Log.e("X:",String.valueOf(xDistance));
        Log.e("Y:",String.valueOf(yDistance));
        ...
        Log.e("Velocity X:",String.valueOf(velocityX));
        Log.e("Velocity Y:",String.valueOf(velocityY));

        if (velocityX > this.swipe_Min_Velocity
                && xDistance > this.swipe_Min_Distance) {
            if (e1.getX() > e2.getX()) // right to left
            {
                Log.e("Swipe Left","Detect");
                this.listener.onSwipe(SWIPE_LEFT);
            }
            else {
                Log.e("Swipe Right","Detect");
